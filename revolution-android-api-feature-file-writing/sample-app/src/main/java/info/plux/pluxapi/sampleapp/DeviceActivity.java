...
public class DeviceActivity extends Activity implements OnBITalinoDataAvailable, View.OnClickListener {
    ...
    private static String BROKER_ADDRESS = "192.168.1.205";
    private static int BROKER_PORT = 1883;
    private IMqttClient mqttClient;
    private static String clientId = "client";
    public static final String TOPIC = "bitalino/sensors";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler(getMainLooper()){
          ...
          public void handleMessage(Message msg) {
               ...
               */
              /*try {
                  Log.i(TAG, "Publishing to topic:" + TOPIC);
...
//                }
    ...
    private MqttMessage getMqttMessage (BITalinoFrame frame) {
        Gson gson = new Gson();
        String payload = gson.toJson(frame);
